...
'[VERSION]2021.3|30.0.1|20210318[/VERSION]
Pick.PickExtraCirclepointFromId "component1:teflon", "2", "1", "2"

'@ pick end point

'[VERSION]2021.3|30.0.1|20210318[/VERSION]
Pick.PickExtraCirclepointFromId "component1:shield", "2", "1", "2"
...
With DiscretePort 
     ...
     .Monitor "True"
     .Radius "0.0"
     .SetP1 "True", "-0.4", "0", "-7.3478807948841e-17"
     .SetP2 "True", "-1.46", "0", "-2.6819764901327e-16"
...
'[VERSION]2021.3|30.0.1|20210318[/VERSION]
Pick.PickExtraCirclepointFromId "component1:teflon", "4", "4", "2"

'@ pick end point

'[VERSION]2021.3|30.0.1|20210318[/VERSION]
Pick.PickExtraCirclepointFromId "component1:shield", "4", "4", "2"
...
With DiscretePort 
     ...
     .Monitor "True"
     .Radius "0.0"
     .SetP1 "True", "-0.4", "100", "-7.3478807948841e-17"
     .SetP2 "True", "-1.46", "100", "-2.6819764901327e-16"
     .InvertDirection "False"
     .LocalCoordinates "False"
     .Wire ""
     .Position "end1"
